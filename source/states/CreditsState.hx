...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS BLERZERK Team'],
			['Xezo', 'xezo1012', 'Owner,ideas,art,UI', 'https://youtube.com/@Xezo1012', 'FFFFFF'],
			['Myzen99', 'myzen99', 'Song_maker', 'https://youtube.com/@myzen99', '2E9AFE'],
			['Night evil', 'night', 'Code,chart', 'https://youtube.com/@nightevil', '8E729A'],
			['Emoji', 'emoji', 'Cove,sprite sheet', 'https://youtube.com/@EMOJI_CH', '2FFD97C'],
			[''],
			['Psych Engine Team'],
