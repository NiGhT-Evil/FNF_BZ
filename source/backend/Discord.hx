...
class DiscordClient
{
	...
	private static final _defaultID:String = "1208336466787311646";
	...
	public static function changePresence(?details:String = 'FNF vs BLERZERK (test)', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Mod Version:1";
